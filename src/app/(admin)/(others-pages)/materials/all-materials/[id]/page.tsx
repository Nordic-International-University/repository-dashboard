...
import { ArrowLeft, Calendar, Download, Edit, Eye, Globe, Trash, User } from 'lucide-react'
  ...
  return (
    <div className="py-6">
      <div className="mb-6 flex items-center">
        ...
        <h1 className="text-2xl font-bold">Resurs tafsilotlari</h1>
      </div>
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                ...
                <Badge className={getStatusColor(resourceData.status)}>
                  {statusTranslations[resourceData.status as ResourceStatus] || resourceData.status}
                </Badge>
              </div>
            </CardHeader>
            <CardContent>
                ...
                <TabsContent value="details" className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p>{resourceData.isPublic ? 'Ommaviy' : 'Shaxsiy'}</p>
                    </div>
                  </div>
                </TabsContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select
                  defaultValue={resourceData.status}
              ...
              <Button className="w-full" asChild>
                <Link href={`/admin/resources/${resourceData.id}/edit`}>
